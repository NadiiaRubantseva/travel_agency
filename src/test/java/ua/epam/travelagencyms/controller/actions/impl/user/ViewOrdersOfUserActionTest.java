...
public class ViewOrdersOfUserActionTest {
    ...
    void testExecute() throws ServiceException {
        ...
        // act
        String path = new ViewOrdersOfUserAction(appContext).execute(myRequest, response);

        // assert
        assertEquals(VIEW_ORDERS_BY_USER_PAGE, path);
