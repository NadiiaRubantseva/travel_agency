...
public class MysqlUserDAO implements UserDAO {
     ...
     *
     * @param user - id will be generated by database. User instance should have not null email, password, name, surname variables.
    ...
    /**
     * Obtains an instance of the User from database by id
     *
     * @param id - the value of the User instance's id variable.
     * @return Optional.ofNullable - user is null if there is no user found.
     * @throws DAOException is wrapper for SQLException
     */
    @Override
    ...
    public boolean isBlocked(long id) throws DAOException {
        try (Connection connection = dataSource.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(GET_IS_USER_BLOCKED)) {
            int k = 0;
            preparedStatement.setLong(++k, id);
            try (ResultSet resultSet = preparedStatement.executeQuery()) {
                if (resultSet.next()) {
