...
public class TourSQLQueries {
    ...
    public static final String ADD_TOUR = "INSERT INTO tour (title, persons, price, hot, type_id, hotel_id, image, description) VALUES (?,?,?,?,?,?,?,?)";
    ...
    public static final String UPDATE_TOUR = "UPDATE tour SET title=?, persons=?, price=?, hot=?, type_id=?, hotel_id=?, image=?, description=? WHERE id=?";
